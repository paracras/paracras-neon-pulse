...
const Index = () => {
  ...
  return <div className="min-h-screen bg-black text-white">
      ...
      <section ref={servicesRef} id="services" className={`py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden transition-opacity duration-1000 ${isVisible.services ? "opacity-100" : "opacity-0"}`}>
      ...
      {/* How It Works */}
      <section ref={howItWorksRef} id="how-it-works" className={`py-24 px-4 sm:px-6 lg:px-8 bg-black/50 relative transition-opacity duration-1000 ${isVisible.howItWorks ? "opacity-100" : "opacity-0"}`}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            step: "Step 1",
            title: "Discover",
            description: "We start by understanding your business, goals, and challenges through a strategy call. This helps us define what you need and how AI automation can deliver real value.",
            benefit: "Strategy Call"
          }, {
            step: "Step 2",
            title: "Implement",
            description: "We design and implement your automation solution—whether it's an AI agent, custom workflow, or integrated tool—tailored specifically to your operations.",
            benefit: "Custom Setup"
          }, {
            step: "Step 3",
            title: "Support",
            description: "We provide continuous support and optimization to ensure your automations evolve with your business and deliver lasting impact.",
            benefit: "Ongoing Success"
          }].map((item, index) => <div key={index} className="relative p-6 border border-purple-500/30 rounded-lg hover:border-purple-500 transition-all duration-300 hover:shadow-glow-sm">
      ...
      <section ref={useCasesRef} id="use-cases" className={`py-24 px-4 sm:px-6 lg:px-8 transition-opacity duration-1000 ${isVisible.useCases ? "opacity-100" : "opacity-0"}`}>
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-16 text-center text-gradient">
          ...
          <div className="mt-16 text-center">
            ...
            <Button variant="purple" size="lg" onClick={() => {
      ...
      {/* Contact Section */}
      <section ref={contactRef} id="contact" className={`py-24 px-4 sm:px-6 lg:px-8 bg-black/50 relative transition-opacity duration-1000 ${isVisible.contact ? "opacity-100" : "opacity-0"}`}>
        <div className="absolute inset-0 bg-grid-pattern opacity-10"></div>
